...
(function () {
    ...
    Markdown.Converter = function () {
        ...
        function _HashHTMLBlocks(text) {
            ...
            // hard-coded:
            var block_tags_a = "h[1-6]"
            var block_tags_b = "h[1-6]"
        ...
        function _DoHeaders(text) {
            ...
            text = text.replace(/^(.+)[ \t]*\n=+[ \t]*\n+/gm,
                function (wholeMatch, m1) { 
                    var elemId = _RunSpanGamut(m1).toString().replace(/\s/g,'-').replace(/<|>|\.|\*|\//g, '');
                    return "<h1 id='" + elemId   + "'>" + _RunSpanGamut(m1) + "</h1>\n\n"; 
                }
            );
            ...
            text = text.replace(/^(.+)[ \t]*\n-+[ \t]*\n+/gm,
                function (matchFound, m1) { 
                    var elemId = _RunSpanGamut(m1).toString().replace(/\s/g,'-').replace(/<|>|\.|\*|\//g, '');
                    return "<h2 id='"+ elemId +"'>" +  _RunSpanGamut(m1) + "</h2>\n\n"; 
                }
            );
            ...
            */
            ...
            text = text.replace(/^(\#{1,6})[ \t]*(.+?)[ \t]*\#*\n+/gm,
                function (wholeMatch, m1, m2) {
                    ...
                    var elemId = _RunSpanGamut(m2).toString().replace(/\s/g,'-').replace(/<|>|\.|\*|\//g, '');
                    return "<h" + h_level + " id='" + elemId + "'>" + _RunSpanGamut(m2) + "</h" + h_level + ">\n\n";
                }
            );
